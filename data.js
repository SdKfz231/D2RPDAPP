...
const itemDatabase = {
	...
	'cap': { name: 'Cap', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/cap.png'  },
	'antlers': { name: 'Antlers', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/antlers.png'  },
	'assualt_helm': { name: 'Assualt Helm', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/assualthelm.png'  },
	'avenger_guard': { name: 'Avenger Guard', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/avengerguard.png'  },
	'coronet': { name: 'Coronet', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/coronet.png'  },
	'diadem': { name: 'Diadem', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/diadem.png'  },
	'falcon_mask': { name: 'Falcon Mask', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/falconmask.png'  },
	'fanged_helm': { name: 'Fanged Helm', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/fangedhelm.png'  },
	'hawk_helm': { name: 'Hawk Helm', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/hawkhelm.png'  },
	'horned_helm': { name: 'Horned Helm', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/hornedhelm.png'  },
	'winged_helm': { name: 'Winged Helm', w: 2, h: 2, color: 'bg-yellow-800', type: 'head', category: 'helms', 
		stats: { ac: 1 }, img: 'assets/armor/helms/wingedhelm.png'  },
	'skull_cap': { name: 'Skull Cap', w: 2, h: 2, color: 'bg-gray-300', type: 'head', category: 'helms', 
		stats: { ac: 2 }, img: 'assets/armor/helms/skullcap.png'  },
	'helm': { name: 'Helm', w: 2, h: 2, color: 'bg-gray-700', type: 'head', category: 'helms', 
		stats: { ac: 3 }, img: 'assets/armor/helms/helm.png'  },
	'mask': { name: 'Mask', w: 2, h: 2, color: 'bg-yellow-600', type: 'head', category: 'helms', 
		stats: { ac: 3 }, img: 'assets/armor/helms/mask.png'  },
	'full_helm': { name: 'Full Helm', w: 2, h: 2, color: 'bg-gray-600', type: 'head', category: 'helms', 
		stats: { ac: 4 }, img: 'assets/armor/helms/fullhelm.png'  },
	...
	'great_helm': { name: 'Great Helm', w: 2, h: 2, color: 'bg-gray-500', type: 'head', category: 'helms', 
		stats: { ac: 5 }, img: 'assets/armor/helms/greathelm.png'  },
	'crown': { name: 'Crown', w: 2, h: 2, color: 'bg-yellow-500', type: 'head', category: 'helms', 
		stats: { ac: 5 }, img: 'assets/armor/helms/crown.png'  },
		//TODO: add unique helms and circlets
	'circlet': { name: 'Circlet', w: 2, h: 2, color: 'bg-yellow-400', type: 'head', category: 'helms', 
		stats: { ac: 6 }, img: 'assets/armor/helms/circlet.png'  },
	'tiara': { name: 'Tiara', w: 2, h: 2, color: 'bg-yellow-400', type: 'head', category: 'helms', 
		stats: { ac: 6 }, img: 'assets/armor/helms/tiara.png'  },
	'spirit_mask': { name: 'Spirit Mask', w: 2, h: 2, color: 'bg-yellow-400', type: 'head', category: 'helms', 
		stats: { ac: 6 }, img: 'assets/armor/helms/spiritmask.png'  },
	'wolfhead': { name: 'Wolfhead', w: 2, h: 2, color: 'bg-yellow-400', type: 'head', category: 'helms', 
		stats: { ac: 6 }, img: 'assets/armor/helms/wolfhead.png'  },

	// Shields
	'buckler': { name: 'Buckler', w: 2, h: 2, color: 'bg-yellow-900', type: 'offhand', category: 'shields', 
		stats: { ac: 1, weight: 'Light' }, img: 'assets/armor/shields/buckler.png'  },
	'small_shield': { name: 'Small Shield', w: 2, h: 2, color: 'bg-yellow-800', type: 'offhand', category: 'shields', 
		stats: { ac: 2, weight: 'Light' }, img: 'assets/armor/shields/smallshield.png'  },
	'large_shield': { name: 'Large Shield', w: 2, h: 3, color: 'bg-yellow-700', type: 'offhand', category: 'shields', 
		stats: { ac: 3, weight: 'Light' }, img: 'assets/armor/shields/largeshield.png'  },
	'spiked_shield': { name: 'Spiked Shield', w: 2, h: 2, color: 'bg-gray-500', type: 'offhand', category: 'shields', 
		stats: { ac: 3, weight: 'Light' }, img: 'assets/armor/shields/spikedshield.png'  },
	'kite_shield': { name: 'Kite Shield', w: 2, h: 3, color: 'bg-blue-300', type: 'offhand', category: 'shields', 
		stats: { ac: 4, weight: 'Light' }, img: 'assets/armor/shields/kiteshield.png'  },
	'bone_shield': { name: 'Bone Shield', w: 2, h: 3, color: 'bg-gray-200', type: 'offhand', category: 'shields', 
		stats: { ac: 5, weight: 'Light' }, img: 'assets/armor/shields/boneshield.png'  },
	'tower_shield': { name: 'Tower Shield', w: 2, h: 3, color: 'bg-gray-500', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Heavy' }, img: 'assets/armor/shields/towershield.png'  },
	'gothic_shield': { name: 'Gothic Shield', w: 2, h: 3, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/gothicshield.png'  },
		//TODO: add unique shields
	'aerin_shield': { name: 'Aerin Shield', w: 2, h: 3, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/aerinshield.png'  },
	'crown_shield': { name: 'Crown Shield', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/crownshield.png'  },
	'demon_head': { name: 'Demon Head', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/demonhead.png'  },
	'preserved_head': { name: 'Preserved Head', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/preservedhead.png'  },
	'gargoyle_head': { name: 'Gargoyle Head', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/gargoylehead.png'  },
	'zombie_head': { name: 'Zombie Head', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/zombiehead.png'  },
	'unraveller_head': { name: 'Unraveller Head', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/unravellerhead.png'  },
	'targe': { name: 'Targe', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/targe.png'  },
	'rondache': { name: 'Rondache', w: 2, h: 2, color: 'bg-red-800', type: 'offhand', category: 'shields', 
		stats: { ac: 6, weight: 'Medium' }, img: 'assets/armor/shields/rondache.png'  },
